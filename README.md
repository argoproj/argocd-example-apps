...
| [![App Status][badge_applicationset]][app_applicationset]                 | [applicationset](applicationset/)                  | One example per ApplicationSet generator type (List, Cluster, Git, Matrix, Merge, Pull Request), including an intentionally-broken Git generator, and progressive sync example Appset |
