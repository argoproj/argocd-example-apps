...
| [![App Status][badge_applicationset]][app_applicationset]                 | [applicationset](applicationset/)                  | An ApplicationSet that deploys the same guestbook manifest across dev/staging/prod environments using a List generator   |
